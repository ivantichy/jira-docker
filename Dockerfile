...
RUN cd / && wget https://product-downloads.atlassian.com/software/jira/downloads/atlassian-jira-software-7.6.0-x64.bin \
&& sha256sum -c check.gpr \
&& chmod a+x atlassian-jira-software-7.6.0-x64.bin \
&& cd / && ./atlassian-jira-software-7.6.0-x64.bin < ./installjira \
&& rm /atlassian-jira-software-7.6.0-x64.bin \
