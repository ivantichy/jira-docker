...
RUN  mkdir /home/dbbackup && cp -r /var/lib/postgresql/9.5/main/* /home/dbbackup/

COPY ./installjira /installjira
COPY ./dbconfig.xml /var/atlassian/jira-home/dbconfig.xml

RUN cd / \
  && wget https://downloads.atlassian.com/software/jira/downloads/atlassian-jira-software-7.3.0-x64.bin \
  && chmod a+x atlassian-jira-software-7.3.0-x64.bin \
  && cd / && ./atlassian-jira-software-7.3.0-x64.bin < ./installjira \
  && rm /atlassian-jira-software-7.3.0-x64.bin \
...
VOLUME /var/lib/postgresql/9.5/main /var/atlassian/jira-app /var/atlassian/jira-home
